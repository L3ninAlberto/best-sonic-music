...
<template>
  <p class="md:mt-5 mx-16 text-center md:text-xl">
    Sonic the Hedgehog has awesome music!
  </p>
  <p class="mx-10 md:mx-16 text-center md:text-xl">
    Happy, epic and emotional... This is a test, can you decide which one is the
    best?
  </p>

  <RouterLink
    to="/vs"
    class="self-center px-14 py-2 text-lg md:text-2xl bg-red-600 rounded-lg shadow-lg shadow-blue-950 hover:bg-red-500"
  >
    Start
  </RouterLink>
